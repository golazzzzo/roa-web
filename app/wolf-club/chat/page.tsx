...
export default function ComunidadPage() {
  ...
  return (
    <main className="bg-[#111114] h-[100dvh] flex flex-col overflow-hidden">
      <Navigation />
      ...
      <div className="flex flex-1 overflow-hidden pt-[72px]">
        ...
        <div className="flex-1 flex flex-col overflow-hidden bg-[#111114]">
          ...
          {/* Channel header */}
          <div className="shrink-0 border-b border-[#1e1e24] px-6 h-11 flex items-center gap-3 bg-[#111114]">
